...
class TestFeatureIntegration:
    ...
    def test_albert_einstein_features(self) -> None:
        ...
        article_data = {
            "data": {
                "parse": {
                    ...
                    "text": {"*": "Albert Einstein was a German-born theoretical physicist. " * 200}
                },
                "query": {
                    "pages": {
                        "123": {
        ...
        all_features = {**structure_feats, **sourcing_feats, **editorial_feats, **network_feats}
        ...
        assert editorial_feats["total_editors"] == 4.0  # PhysicsEditor, ScienceBot, EinsteinFan, AcademicEditor
        ...
        for feature_name, feature_value in all_features.items():
            assert isinstance(feature_value, (int, float)), f"Feature {feature_name} is not numeric: {type(feature_value)}"
    ...
    def test_dog_features(self) -> None:
        ...
        article_data = {
            "data": {
                "parse": {
                    ...
                    "text": {"*": "The dog is a domesticated descendant of the wolf. " * 150}
                },
                "query": {
                    "pages": {
                        "456": {
        ...
        assert editorial_feats["total_editors"] == 5.0  # DogLover, VetEditor, AnimalBot, IP user, AnimalExpert
    ...
    def test_feature_normalization(self) -> None:
        ...
        extensive_data = {
            "data": {
                "parse": {
                    "sections": [{"index": i, "line": f"Section {i}", "level": 1} for i in range(1, 21)],
                    "text": {"*": "Very long content " * 1000}
                },
                "query": {
                    "pages": {
                        "123": {
                            "extlinks": [{"url": f"https://example{i}.com"} for i in range(50)],
                            "revisions": [
                                {
                                    "revid": i,
        ...
        assert extensive_features["log_section_count"] > minimal_features["log_section_count"]
